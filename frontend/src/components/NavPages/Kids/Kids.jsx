...
export default function Kids() {
  const categories = [
    "T-Shirts", "Shorts", "Nightwear",
    "Winterwear", "Hoodies", "Fun Wear",
  ];

  const brands = [
    "H&M Kids", "BabyGo", "Nike Kids",
    "Mothercare", "Bewakoof", "AUIND Kids",
  ];

  const sizes = ["2-4Y", "4-6Y", "6-8Y", "8-10Y", "10-12Y"];

  const products = [
    { id: 1, brand: "H&M Kids", name: "Cartoon Print Tee", price: 499, oldPrice: 899, rating: 4.4, reviews: 390, img: "https://images.pexels.com/photos/6311639/pexels-photo-6311639.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "T-Shirts", size: "6-8Y" },
    { id: 2, brand: "AUIND Kids", name: "Cute Summer Set", price: 699, oldPrice: 1299, rating: 4.3, reviews: 240, img: "https://images.pexels.com/photos/3182772/pexels-photo-3182772.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Fun Wear", size: "4-6Y" },
    { id: 3, brand: "Bewakoof", name: "Kids Hoodie (Soft)", price: 999, oldPrice: 1799, rating: 4.5, reviews: 550, img: "https://images.pexels.com/photos/6311661/pexels-photo-6311661.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Hoodies", size: "8-10Y" },
    { id: 4, brand: "Nike Kids", name: "Winterwear Jacket", price: 1399, oldPrice: 2399, rating: 4.3, reviews: 260, img: "https://images.pexels.com/photos/6311647/pexels-photo-6311647.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Winterwear", size: "10-12Y" },
    { id: 5, brand: "Mothercare", name: "Soft Nightwear Set", price: 799, oldPrice: 1499, rating: 4.2, reviews: 210, img: "https://images.pexels.com/photos/6311635/pexels-photo-6311635.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Nightwear", size: "6-8Y" },
    { id: 6, brand: "AUIND Kids", name: "Kids Denim Shorts", price: 499, oldPrice: 999, rating: 4.1, reviews: 180, img: "https://images.pexels.com/photos/6311663/pexels-photo-6311663.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Shorts", size: "8-10Y" },
  ];
  ...
  const FilterPanel = ({ onApply }) => (
    <div className="space-y-6 text-white">
      ...
      {/* Sizes */}
      <div>
        <h4 className="text-xs font-bold uppercase tracking-widest text-cyan-400 mb-3">Age / Size</h4>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-5">
          <nav className="text-xs text-gray-500 mb-2 flex items-center gap-1.5">
            ...
            <span>›</span>
            <span className="text-cyan-400 font-semibold">Kids</span>
          </nav>
          ...
          <p className="text-xs text-gray-400 mt-1">
            Playful • Stylish •{" "}
            <span className="text-cyan-400 font-semibold">AUIND Kidswear</span>
          </p>
        </div>
                      ...
                      <div className="w-full h-44 sm:h-52 bg-gray-100 overflow-hidden">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            e.target.src = "https://images.pexels.com/photos/6311639/pexels-photo-6311639.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800";
                          }}
                        />
                      </div>
