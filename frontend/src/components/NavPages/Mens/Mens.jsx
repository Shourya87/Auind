...
export default function Mens() {
  const categories = [
    "T-Shirts", "Shirts", "Hoodies", "Jackets",
    "Jeans", "Bottom Wear", "Streetwear",
  ];

  const brands = [
    "Highlander", "Bewakoof", "Campus Sutra",
    "United Colors", "Fubar", "AUIND",
  ];

  const sizes = ["XS", "S", "M", "L", "XL", "XXL"];

  const products = [
    { id: 1, brand: "HIGHLANDER", name: "Men Printed Casual Shirt", price: 609, oldPrice: 3399, rating: 4.4, reviews: 1420, img: "/mnt/data/225bb058-7f0d-415f-8e1f-78aa90b1b1a9.png", category: "Shirts", size: "L" },
    { id: 2, brand: "BEWAKOOF", name: "Men Oversized Graphic Tee", price: 599, oldPrice: 1299, rating: 4.4, reviews: 1020, img: "https://images.pexels.com/photos/6311656/pexels-photo-6311656.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "T-Shirts", size: "M" },
    { id: 3, brand: "AUIND", name: "Streetwear Boxy Tee", price: 699, oldPrice: 1499, rating: 4.1, reviews: 278, img: "https://images.pexels.com/photos/1701193/pexels-photo-1701193.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "T-Shirts", size: "L" },
    { id: 4, brand: "CAMPUS SUTRA", name: "Slim Fit Cotton Shirt", price: 579, oldPrice: 2899, rating: 3.9, reviews: 147, img: "https://images.pexels.com/photos/428340/pexels-photo-428340.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Shirts", size: "M" },
    { id: 5, brand: "FUBAR", name: "Bomber Jacket", price: 1799, oldPrice: 2999, rating: 4.5, reviews: 450, img: "https://images.pexels.com/photos/1468378/pexels-photo-1468378.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Jackets", size: "XL" },
    { id: 6, brand: "HIGH&CO", name: "Soft Winter Hoodie", price: 1499, oldPrice: 2499, rating: 4.2, reviews: 310, img: "https://images.pexels.com/photos/6311393/pexels-photo-6311393.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Hoodies", size: "L" },
    { id: 7, brand: "BEWAKOOF", name: "Daily Casual Tee", price: 499, oldPrice: 899, rating: 4.0, reviews: 670, img: "https://images.pexels.com/photos/1143763/pexels-photo-1143763.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "T-Shirts", size: "M" },
    { id: 8, brand: "FUBAR", name: "Slim Fit Trousers", price: 899, oldPrice: 1699, rating: 4.1, reviews: 210, img: "https://images.pexels.com/photos/6311661/pexels-photo-6311661.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Bottom Wear", size: "L" },
    { id: 9, brand: "AUIND", name: "Trendy Overshirt", price: 1299, oldPrice: 2299, rating: 4.3, reviews: 390, img: "https://images.pexels.com/photos/1139743/pexels-photo-1139743.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Shirts", size: "XL" },
    { id: 10, brand: "HIGH&CO", name: "Printed Urban Tee", price: 699, oldPrice: 1299, rating: 4.0, reviews: 220, img: "https://images.pexels.com/photos/1524133/pexels-photo-1524133.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "T-Shirts", size: "S" },
    { id: 11, brand: "UNITED", name: "Classic White Shirt", price: 899, oldPrice: 1699, rating: 4.2, reviews: 180, img: "https://images.pexels.com/photos/6311644/pexels-photo-6311644.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Shirts", size: "M" },
    { id: 12, brand: "AUIND", name: "Premium Black Jeans", price: 1299, oldPrice: 1999, rating: 4.6, reviews: 520, img: "https://images.pexels.com/photos/1598505/pexels-photo-1598505.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800", category: "Jeans", size: "L" },
  ];
  ...
  const toggle = (arrSetter, arr, val) =>
    arr.includes(val) ? arrSetter(arr.filter((x) => x !== val)) : arrSetter([...arr, val]);
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-2">
          {categories.map((c) => (
            <button
              key={c}
              onClick={() => toggle(setSelectedCats, selectedCats, c)}
            ...
            >
              <span className={`w-3.5 h-3.5 rounded-sm border flex items-center justify-center flex-shrink-0 transition-all ${
                selectedCats.includes(c) ? "bg-cyan-400 border-cyan-400" : "border-gray-500"
              }`}>
            ...
            <button
              ...
              className={`w-12 h-10 rounded-lg text-sm font-semibold border transition-all ${
                selectedSizes.includes(s)
                  ? "bg-cyan-500 text-black border-cyan-500 shadow-[0_0_12px_rgba(6,182,212,0.4)]"
      ...
      <div>
        ...
        <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
          {brands.map((b) => (
            <button
              key={b}
              onClick={() => toggle(setSelectedBrands, selectedBrands, b)}
              className={`w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm border transition-all text-left ${
            ...
            >
              <span className={`w-3.5 h-3.5 rounded-sm border flex items-center justify-center flex-shrink-0 transition-all ${
                selectedBrands.includes(b) ? "bg-cyan-400 border-cyan-400" : "border-gray-500"
              }`}>
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-[#0b1215] rounded-t-3xl max-h-[88vh] flex flex-col border-t border-white/10 shadow-2xl">
            ...
            <div className="flex items-center justify-between px-5 py-3 border-b border-white/10 flex-shrink-0">
              ...
              <div className="flex items-center gap-3">
                {activeFilterCount > 0 && (
                  <button onClick={clearAll} className="text-xs text-cyan-400 font-semibold">
                    Clear All
                  </button>
                )}
                <button
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-5">
          <nav className="text-xs text-gray-500 mb-2 flex items-center gap-1.5">
            ...
            <span>›</span>
            <span className="text-cyan-400 font-semibold">Mens</span>
          </nav>
        ...
        {/* ── MOBILE TOP TOOLBAR (Filter + Sort pills) ── */}
        <div className="flex gap-2 mb-4 lg:hidden">
          ...
          >
            ...
            Filters
            {activeFilterCount > 0 && (
              <span className="bg-cyan-500 text-black text-xs font-bold w-4 h-4 rounded-full flex items-center justify-center">
                {activeFilterCount}
              </span>
            )}
          </button>
          ...
          <div className="flex gap-2 mb-4 overflow-x-auto pb-1 lg:hidden scrollbar-hide">
            {selectedCats.map((c) => (
              <span key={c} className="flex-shrink-0 flex items-center gap-1.5 bg-cyan-500/15 border border-cyan-500/40 text-cyan-300 text-xs px-3 py-1.5 rounded-full font-medium">
                {c}
                <button onClick={() => toggle(setSelectedCats, selectedCats, c)}><FaTimes className="text-[10px]" /></button>
              </span>
            ))}
            {selectedSizes.map((s) => (
              <span key={s} className="flex-shrink-0 flex items-center gap-1.5 bg-cyan-500/15 border border-cyan-500/40 text-cyan-300 text-xs px-3 py-1.5 rounded-full font-medium">
                Size: {s}
                <button onClick={() => toggle(setSelectedSizes, selectedSizes, s)}><FaTimes className="text-[10px]" /></button>
              </span>
            ))}
            {selectedBrands.map((b) => (
              <span key={b} className="flex-shrink-0 flex items-center gap-1.5 bg-cyan-500/15 border border-cyan-500/40 text-cyan-300 text-xs px-3 py-1.5 rounded-full font-medium">
                {b}
                <button onClick={() => toggle(setSelectedBrands, selectedBrands, b)}><FaTimes className="text-[10px]" /></button>
              </span>
            ))}
            <button onClick={clearAll} className="flex-shrink-0 text-xs text-gray-400 px-2 py-1.5 underline">
              Clear all
            </button>
          </div>
        )}
        ...
        <div className="flex gap-6">
              ...
              <div className="rounded-2xl p-5 border border-white/10 bg-gradient-to-b from-white/5 to-white/[0.02] backdrop-blur-sm">
                <div className="flex items-center justify-between mb-5">
                  <h3 className="text-base font-bold text-white flex items-center gap-2">
                    ...
                    Filters
                    {activeFilterCount > 0 && (
                      <span className="bg-cyan-500 text-black text-xs font-bold px-1.5 py-0.5 rounded-full">
                        {activeFilterCount}
                      </span>
                    )}
                  </h3>
                  {activeFilterCount > 0 && (
                    <button onClick={clearAll} className="text-xs text-cyan-400 font-semibold hover:text-cyan-300 transition">
                      Clear All
                    </button>
                  )}
                </div>
          ...
          <section className="flex-1 min-w-0">
            {/* Desktop results count + sort info */}
            ...
            {filtered.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <button onClick={clearAll} className="px-5 py-2.5 rounded-xl bg-cyan-500 text-black text-sm font-bold">
                  Clear Filters
                </button>
              </div>
            ) : (
                ...
                {filtered.map((p) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {isWishlist
                          ? <GiHeartWings className="text-red-500 text-base" />
                      ...
                      <div className="w-full h-44 sm:h-52 bg-gray-100 overflow-hidden">
                        <img
                          ...
                          onError={(e) => {
                            ...
                            e.target.src = "https://images.pexels.com/photos/428340/pexels-photo-428340.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800";
                          }}
                        />
                      </div>
                      ...
                      <div className="px-3 py-2.5">
                        ...
                        <div className="mt-2 flex items-center justify-between">
                          <div>
                            ...
                            <span className="text-base font-bold text-cyan-600 leading-tight">₹{p.price}</span>
                          </div>
